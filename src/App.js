      ...
      <div className="max-w-4xl mx-auto p-6 bg-white rounded-lg shadow-lg">
        <div className="text-center">
          <h1 className="text-3xl font-bold text-gray-800 mb-4">
            Physical Security Risk Evaluator Quiz
          </h1>
          <p className="text-gray-600 mb-6">
            Test your knowledge with 90 questions about physical security risk evaluation.
          ...
          <div className="mt-6 text-sm text-gray-500">
            ...
            <p>Answer Format: Multiple choice (some questions may have multiple correct answers)</p>
          </div>
        </div>
      </div>
    );
    ...
    <div className="max-w-4xl mx-auto p-6 bg-white rounded-lg shadow-lg">
      ...
      <div className="mb-6">
        <div className="flex justify-between text-sm text-gray-600 mb-2">
          ...
          <span>{Math.round(((currentQuestionIndex + 1) / randomizedQuestions.length) * 100)}% Complete</span>
        </div>
      ...
      {currentQuestionIndex === randomizedQuestions.length - 1 && showResult && (
        <div className="mt-6 p-4 bg-blue-50 border border-blue-200 rounded-lg text-center">
          <h3 className="text-lg font-semibold text-blue-800 mb-2">Quiz Progress</h3>
          <p className="text-blue-700">
            You've answered {totalAnswered} questions with a score of {score}/{totalAnswered} 
